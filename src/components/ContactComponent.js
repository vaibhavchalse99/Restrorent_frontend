...
import {Breadcrumb,BreadcrumbItem, Form,Label, Button, Col,Row} from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(values){
        console.log('Data is '+JSON.stringify(values))
        alert('Data is '+JSON.stringify(values))
    }
